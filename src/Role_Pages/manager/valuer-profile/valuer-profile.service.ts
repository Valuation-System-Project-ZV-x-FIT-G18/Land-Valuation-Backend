...
export class ValuerProfileService implements OnModuleInit {
  ...
  async save(dto: SaveValuerProfileDto) {
    ...
    const result = await this.db.query(`INSERT INTO valuer_profiles (
      ...
      ivsl_registration_number, rics_registration_number, relevant_experience,
    ...
    ON CONFLICT (user_id) DO UPDATE SET
      ...
      dto.professionalQualifications.trim(), dto.ivslRegistrationNumber.trim(), dto.ricsRegistrationNumber?.trim() ?? '',
